...
\begin{table}[h!]
    ...
    \hline
    \textbf{Specific - Tính cụ thể} & Mục tiêu ở đây là sẽ xây dựng được hệ thống nhận diện và đếm phương tiện. \\
    \hline
    \textbf{Measurable - Đo lường được} & Độ chính xác: Precision ~90\% và F1 >= 60\%, nhận diện được các loại xe và đếm các loại phương tiện một cách chính xác. \\
    \hline
    \textbf{Achievable - Có thể đạt được} & Mục tiêu có thể đạt được nếu nhóm sử dụng công nghệ phù hợp và có đủ thời gian \& tài nguyên. \\
    \hline
    \textbf{Relevant - thích hợp} & Với các thiết bị chi phí thấp và những nghiên cứu liên quan hỗ trợ, đồ án có tính khả thi (thực hiện được). \\
    \hline
    \textbf{Time Bound - Giới hạn thời gian} & Đã đặt deadline cho mục tiêu trong timeline. \\
    \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \textbf{Các tiêu chí} & \textbf{Mô tả} \\
    \hline
    \textbf{Specific - Cụ thể} & Phát triển phần mềm trên máy chủ để hỗ trợ tương tác với người dùng và cơ sở dữ liệu. \\
    \hline
    \textbf{Measurable - Đo lường được} & Đảm bảo cập nhật tình trạng giao thông thời gian thực, không quá 30 giây so với tình trạng giao thông ngoài thực tế. \\
    \hline
    \textbf{Achievable - Có thể đạt được} & Kế hoạch được hoạch định và chia nhỏ cho các thành viên. \\
    \hline
    \textbf{Relevant - Thích hợp} & Quy mô của kiến trúc hệ thống vừa phải, sử dụng công nghệ mở, nên mục tiêu khả thi. \\
    \hline
    \textbf{Time Bound - Giới hạn thời gian} & Đã đặt deadline cho mục tiêu trong timeline. \\
    \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \textbf{Các tiêu chí} & \textbf{Mô tả} \\
    \hline
    \textbf{Specific - Cụ thể} & Triển khai giải pháp phần mềm trên các phần cứng IoT. \\
    \hline
    \textbf{Measurable - Đo lường được} & 
    \begin{itemize}
      \item Độ chính xác (F1) \>= 60\% (vì triển khai trên phần cứng IoT)
    ...
    \\
    \hline
    \textbf{Achievable - Có thể được được} & Kế hoạch cần chi tiết và phù hợp với các thành viên trong nhóm. \\
    \hline
    \textbf{Relevant - Thích hợp} & Phần cứng không quá phức tạp, có sự hỗ trợ của các thư viện nạp mã nguồn nên mục tiêu khả thi. \\
    \hline
    \textbf{Time Bound - Giới hạn thời gian} & Đã đặt deadline cho mục tiêu trong timeline. \\
    \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{7cm}|p{10cm}|}
    \hline
    \textbf{Tên} & Người tham gia giao thông \\ 
    \hline
    \textbf{Mô tả} & Sử dụng giao diện người dùng \\ 
    \hline
    \textbf{Trách nhiệm} & \begin{itemize}
        \item Cung cấp các yêu cầu đủ rõ ràng và chi tiết
        \item Cung cấp nhận xét về tiến độ dự án
    \end{itemize} \\ 
    \hline
    \textbf{Các bên liên quan} & Tự đại diện \\ 
    \hline
    \end{tabular}
    \caption{Thông tin về các bên liên quan}
\end{table}
