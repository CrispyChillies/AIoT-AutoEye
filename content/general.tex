...
\begin{table}[h!]
    ...
    \hline
    \textbf{Measurable - Đo lường được} & Độ chính xác mong muốn trên 65\%, nhận diện được các loại xe và đếm các loại phương tiện một cách chính xác. \\
    \hline
...
\begin{table}[h!]
    ...
    \begin{itemize}
      \item Độ chính xác \>= 60\% (vì triển khai trên phần cứng IoT)
