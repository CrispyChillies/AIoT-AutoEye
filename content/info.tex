...
\begin{table}[H]
    ...
    Cập nhật timeline (mục 11) & Phiên bản gần nhất có thay đổi timeline ở gantchart nhưng cập nhật thiếu ở specs & Cập nhật timeline ứng với tình hình thực tế của dự án\\ \hline
    \end{tabular}
\end{table}
