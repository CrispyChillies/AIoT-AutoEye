...
\begin{enumerate}
    ...
    \textbf{Luồng xử lý:}
    \begin{itemize}
        \item Người dùng chọn thời gian cần thống kê (ví dụ: từ 6h đến 9h ngày 28/5).
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|p{4cm}|p{10cm}|}
            ...
            Cơ sở dữ liệu & Bảng \texttt{traffic\_log} (ghi lại số lượng xe, thời gian) \\ \hline
        \end{tabular}
    \end{table}
...
\begin{itemize}
    ...
    \item Ngày kết thúc: 30/05/2025
    \item Công việc:
    \begin{itemize}
        \item Lên kế hoạch cho dự án
        \item Kế hoạch phát triển dự án
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Ngày bắt đầu: 28/05/2025
    \item Ngày kết thúc: 30/05/2025
    \item Công việc:
    \begin{itemize}
        \item Định nghĩa giải pháp phần mềm cho dự án
        \item Định nghĩa giải pháp phần cứng cho dự án
        \item Khảo sát giải pháp cho dự án
        \item Định nghĩa các hướng ứng dụng của dự án
        \item Thông số yêu cầu hệ thống
        \item Thiết kế kiến trúc hệ thống
        \item Xem xét và dịch bản trình bày
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Ngày bắt đầu: 31/05/2025
    \item Ngày kết thúc: 28/07/2025
    \item Công việc:
    \begin{itemize}
        \item Trình bày dự án
        \item Phát triển phần mềm
        \item Cài đặt giao diện người dùng
        \item Xây dựng cơ sở dữ liệu để lưu trữ
        \item Cài đặt hệ thống server cho thiết bị
        \item Thu nhận phần cứng
        \item Thu mua ESP32-CAM
        \item Thiết kế và phát triển phần cứng
        \item Set Up MQTT Server
        \item Tích hợp phần cứng và phần mềm 
        \item Cài đặt module rút trích đặc trưng
        \item Cài đặt module phân loại tình trạng giao thông
        \item Cài đặt module xác định vị trí phương tiện
    \end{itemize}
\end{itemize}

\subsection{Giai đoạn 4}
\begin{itemize}
    \item Ngày bắt đầu: 28/07/2025
    \item Ngày kết thúc: 01/08/2025
    \item Công việc:
    \begin{itemize}
        \item Đảm bảo chất lượng thông qua kiểm thử triển khai
        \item Chuẩn bị thuyết trình dự án
        \item Làm slide thuyết trình
        \item Chuẩn bị nội dung
        \item Review nội dung 
        \item Thuyết trình dự án
    \end{itemize}
\end{itemize}
