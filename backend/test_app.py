...
def test_users():
    ...
    # Test updating user
    update_data = {"personal": {"name": "John Smith", "email": "johnsmith@example.com"}}
...
def test_traffic():
    ...
    with open(image_path, "rb") as img_file:
        files = {"image": ("traffic.jpg", img_file, "image/jpeg")}
        data = {
            "_id": "traffic123",
            "location": "Location A",
            "vehicle_count": "120",
...
if __name__ == "__main__":
    try:
        ...
        print(
            "❌ Error: Could not connect to Flask server. Make sure it's running on http://localhost:5000"
        )
    except Exception as e:
