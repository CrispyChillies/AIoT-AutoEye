...
class Evaluator:
    ...
    def __init__(
        ...
        Args:
            ...
            tensorboard_enabled: Whether TensorBoard is enabled for this learn block
        """
    ...
    def classification(
        ...
        try:
            ...
            if (self._tensorboard_enabled):
                self._generate_tensorboard_roc_curves(y_true_one_hot, y_pred_probs, class_names)
    ...
    def _generate_tensorboard_roc_curves(self, y_true, y_pred, class_names, num_thresholds=101):
        """
        ...
        for ix in range(0, num_classes):
            ...
            if self._model_type:
                ...
                curve_dir = os.path.join(tensorboard_log_dir, cur_classname)
            ...
            pr_curve_summary = summary.op(name=curve_name,
